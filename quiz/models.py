...
class Quiz(models.Model):
    ...
    url = models.SlugField(max_length=255, blank=False, help_text=_("a user friendly url"), verbose_name=_("user friendly url"))
...
class Progress(models.Model):
    ...
    correct_answer = models.CharField(max_length=255, verbose_name=_('Correct Answers'), null = True, blank=True)
    wrong_answer = models.CharField(max_length=255, verbose_name=_('Wrong Answers'), null = True, blank=True)
...
class CSVUpload(models.Model):
    ...
    file        = models.FileField(max_length=255, upload_to=upload_csv_file, validators=[csv_file_validator])
